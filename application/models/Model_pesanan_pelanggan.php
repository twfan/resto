...
class Model_pesanan_pelanggan extends CI_Model{
	...
	{
		$query = $this->db->query("SELECT pesanan_pelanggan.id_pesanan, pesanan_pelanggan.kode_resto,  about_resto.nama_resto, pesanan_pelanggan.id_pelanggan, pesanan_pelanggan.jumlah_kursi, pesanan_pelanggan.tanggal_acara, pesanan_pelanggan.jam_acara, pesanan_pelanggan.total_bayar, pesanan_pelanggan.bukti_bayar, pesanan_pelanggan.tanggal_transaksi, pesanan_pelanggan.status_pemesanan FROM `pesanan_pelanggan`,  `about_resto` WHERE pesanan_pelanggan.id_pesanan ='$id_pesanan' AND about_resto.kode_resto = pesanan_pelanggan.kode_resto AND pesanan_pelanggan.status_pemesanan = 'lanjut pembayaran'");
		return $query->result();
	}
