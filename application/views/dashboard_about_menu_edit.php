...
<div class="container-fluid wrapper" >
	<div class="row header">
		...
		<a href="<?php echo base_url('owner/log_out') ?>"> <div class="col-md-2 sign-out"><h5>Sign Out  <span class="glyphicon glyphicon-log-out" ></span></h5></div></a>
	</div>
						    ...
						    <div id="makanan" class="tab-pane fade in active">
						    	...
						    	<?php echo form_open_multipart(base_url("owner/update_makanan"), 'method="POST"') ?>
						    		<div class="row">
								        ...
								        <div class="col-md-4">
								        	<div class="form-group">
								        		<input type="text" class="form-control" placeholder="Nama makanan atau minuman"  name="namamakanan" maxlength="35" value="<?php echo $record_edit->nama_makanan ?>"/>
								        	</div>
								        </div>
							        </div>
							        <div class="row">
								        ...
								        <div class="col-md-4">
								        	<div class="form-group">
								        		<textarea class="form-control" rows="4" cols="74" name="deskripsimakanan" value="" placeholder="Deskripsi makanan"><?php echo $record_edit->deskripsi ?></textarea>
								        	</div>
								        </div>
							        </div>
							        <div class="row">
								        ...
								        <div class="col-md-2">
								        	<div class="form-group">
								        		<input type="text" class="form-control" placeholder="Harga"  name="hargamakanan" maxlength="35" value="<?php echo $record_edit->harga ?>"/>
								        	</div>
								        </div>
							        </div>
							        <div class="row">
							        ...
							        <input type="hidden" name="id" value="<?php echo $record_edit->kode_menu ?>"></input>
							        <div class="row">
							        	<div class="col-md-2"></div>
							        	<div class="col-md-2 ">
